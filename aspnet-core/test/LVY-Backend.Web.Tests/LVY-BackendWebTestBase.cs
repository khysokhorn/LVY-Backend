...
public abstract class LVY-BackendWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static LVY-BackendWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(LVY-BackendWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<LVY-BackendDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<LVY-BackendDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<LVY-BackendDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<LVY-BackendDbContext, Task<T>> func)
    {
        T result;
